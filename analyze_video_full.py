...
"""
===============================================================================
FULL VIDEO ANALYSIS - 완전한 비디오 분석 시스템
===============================================================================

이 스크립트는 student_engagement_analysis.py의 전체 기능을 제공합니다.
학생별 참여도를 자동으로 분석하고 상세 리포트를 생성합니다.

사용법:
    python analyze_video_full.py

결과:
    outputs/reports/ 폴더에 JSON과 HTML 리포트 생성
...
print("=" * 80)
print("FULL VIDEO ANALYSIS - Complete Student Engagement Analysis")
print("=" * 80)

# ============================================================================
# STUDENT TRACKER (학생 추적)
# ============================================================================

class StudentTracker:
    """학생 ID 추적 - 프레임 간 같은 학생 유지"""
...
# ============================================================================
# IMPROVED PERSON DETECTOR (개선된 사람 감지)
# ============================================================================

class ImprovedDetector:
    """MOG2 배경 차감을 이용한 사람 감지"""
...
for stats in summary[:10]:  # 상위 10명만 표시
...
if len(summary) > 10:
    print(f"  ... and {len(summary) - 10} more students")
...
# JSON 저장
json_file = output_dir / f'student_engagement_full_{timestamp}.json'
...
<body>
    <div class="container">
        <h1>Classroom Student Engagement Analysis - Full Report</h1>
...
html_file = output_dir / f'student_engagement_full_{timestamp}.html'
